...
export const IconCubeOutline = (props: React.SVGProps<SVGSVGElement>)=>{
  return (
    <svg
      viewBox="0 0 512 512"
      fill="currentColor"
...
export const IconBxChart = (props: React.SVGProps<SVGSVGElement>)=> {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const IconSettings2 = (props: React.SVGProps<SVGSVGElement>)=> {
  return (
    <svg
      fill="none"
      stroke="currentColor"
...
export const IconNotificationsOutline =(props: React.SVGProps<SVGSVGElement>)=> {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="currentColor"
...
export const IconLogoutCircleLine = (props: React.SVGProps<SVGSVGElement>)=> {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const IconFileAdd = (props: React.SVGProps<SVGSVGElement>)=> {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 16 16"
...
export const IconArrowTrendDown = (props: React.SVGProps<SVGSVGElement>)=>{
  return (
    <svg
      viewBox="0 0 576 512"
      fill="currentColor"
      ...
      {...props}
    >
      <path d="M384 352c-17.7 0-32 14.3-32 32s14.3 32 32 32h160c17.7 0 32-14.3 32-32V224c0-17.7-14.3-32-32-32s-32 14.3-32 32v82.7L342.6 137.4c-12.5-12.5-32.8-12.5-45.3 0L192 242.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0L320 205.3 466.7 352H384z" />
    </svg>
  );
}


export const IconArrowTrendUp = (props: React.SVGProps<SVGSVGElement>)=> {
  return (
    <svg
      viewBox="0 0 576 512"
      fill="currentColor"
...
export const IconCalender = (props: React.SVGProps<SVGSVGElement>) =>{
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const IconCartShopping = (props: React.SVGProps<SVGSVGElement>)=> {
  return (
    <svg
      viewBox="0 0 576 512"
      fill="currentColor"
...
export const IconMoneyDollarCircleFill = (props: React.SVGProps<SVGSVGElement>)=> {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const IconMoonFoggyFill = (props: React.SVGProps<SVGSVGElement>)=> {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const IconCaretDown = function (props: React.SVGProps<SVGSVGElement>) {
  ...
  export const IconNotificationsOff =  (props: React.SVGProps<SVGSVGElement>) => {
    return (
      <svg
        viewBox="0 0 512 512"
        fill="currentColor"
  ...
  export const IconRemoveFill =  (props: React.SVGProps<SVGSVGElement>) => {
    return (
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
  ...
  export const IconBarChartLineFill = (props: React.SVGProps<SVGSVGElement>) =>{
    return (
      <svg
        fill="currentColor"
        viewBox="0 0 16 16"
